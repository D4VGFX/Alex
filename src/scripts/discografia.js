// discografia.js — Alex Natola | Discografia
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── 2. Scroll reveal per le sezioni hero ──────────────────────────────────
  ...
  // ── 6. Waveform SVG animata sotto ogni hero ───────────────────────────────
  ...
  // ── 7. Ripple effect sui pulsanti streaming ───────────────────────────────
  ...
  // ── 8. Stagger animazione link menu ──────────────────────────────────────
